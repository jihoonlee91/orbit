...
- Clearing all the balls on screen clears the stage. There are 80 stages: a world-tour of real landmarks spanning two arcs (1-20, 21-30), dimension-warp portals (31-40), an undersea current (41-50, "The Trench"), a gravity well (51-60, "Stellar Forge"), an arc that travels outward from the solar system through the galaxy into deep space and ends on a Hellfire finale (61-70), and a final spinning "vortex" gravity-well arc culminating in The Singularity (71-80). Clear all 80 to clear the game, with a certificate-style celebration every 10 stages.
