...
- Clearing all the balls on screen clears the stage. There are 100 stages: a world-tour of real landmarks spanning two arcs (1-20, 21-30), dimension-warp portals (31-40), an undersea current (41-50, "The Trench"), a gravity well (51-60, "Stellar Forge"), a spinning "vortex" gravity-well arc culminating in The Singularity (71-80), a "nebula field" flight toward a blazing stellar core (61-70, "Cosmic Frontier"), periodic damage "fire zones" through a hellscape (81-90, "Hell"), and near-zero gravity through an emptying void (91-100, "Void"). Clear all 100 to clear the game, with a certificate-style celebration every 10 stages.
